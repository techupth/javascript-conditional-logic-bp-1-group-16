...
/*กำหนดให้ Function ที่ชื่อว่า calculateStudentGrade 
รับ Parameter 1 ตัวเป็นคะแนน score
Function calculateStudentGrade 
ทำหน้าที่ในการคำนวณเกรดนักเรียนอย่างง่าย 
โดยที่จะ Return เกรดที่นักเรียนได้ตาม Argument ที่กำหนดเข้ามา
เงื่อนไขคือ
